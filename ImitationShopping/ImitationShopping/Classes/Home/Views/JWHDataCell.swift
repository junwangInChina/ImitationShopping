...
class JWHDataCell: UITableViewCell {
    ...
    var itemModle: JWHomeItemModle? {
        didSet {
            
            self.itemImageView.sd_setImageWithURL(NSURL.init(string: itemModle!.itemCoverImageURL!),
                                                  placeholderImage: UIImage.init(named: "placeholder_Image"))
            self.titleLable.text = itemModle!.itemTitle
            self.likeButton.setTitle(String(itemModle!.itemLikeCount!),
